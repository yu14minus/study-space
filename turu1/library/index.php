...
<html lang="ja">
  <head>
    ...
    <title>総合・国際文化学図書館 - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    <?php include '../../../../common/include/gn.php' ?>
    <div id="wrapper">
        <a href="../">
            <img src="../../common/syousai/turu1.svg" alt="turu1" id="campusName">
        </a>
        ...
        <div class="star_div">
            ...
            <img src="./rakomohosi.svg" alt="hosi" class="star" id="rakomo_star">
        </div>
        <img src="../../common/syousai/konsento.svg" alt="attention" class="attention">
        ...
        <div class="information">
            ...
            <a href="https://lib.kobe-u.ac.jp/libraries/list/kokusai/">
                <img src="./kousikisaito.svg" alt="kousikisaito" class="officialSite">
            </a>
            <a href="https://lib.kobe-u.ac.jp/libraries/list/kokusai/floormap/">
