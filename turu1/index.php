...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="./turu1.css">
    ...
    <title>鶴甲第1キャンパス - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    <?php include '../../../common/include/gn.php' ?>
    <div id="wrapper">
    
    <img src="./turu1.svg" alt="turu1" id="campusname">
    <a href="../">
    ...
    <div id="mapAndPin">
        ...
        <img src="../common/map/pin3.svg" alt="pin3" class="pin" id="library_pin" onclick="showBalloon_library()">
        <div class="fukidasi" id="library_fukidasi">
            ...
            <img src="./library/4.jpeg" alt="library" class="fukidasi_image image2">
            <a href="./library/">
                <img src="../common/map/syousaikochira.svg" alt="syousai" class="fukidasi_syousai syousai2">
            </a>
        </div>

        <img src="../common/map/pin1.svg" alt="pin1" class="pin" id="Atou1F_pin" onclick="showBalloon_Atou1F()">
        <div class="fukidasi" id="Atou1F_fukidasi">
            <img src="./ra-komo.svg" alt="Atou1F" class="fukidasi_haikei">
            <img src="./Atou1F/1.jpeg" alt="Atou1F" class="fukidasi_image">
            <a href="./Atou1F/">
