...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="./keieikeizai.css">
    ...
    <title>経済経営研究所図書館 - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    ...
    <div id="wrapper">
        ...
        <img src="./taitoru.svg" alt="keizaikeiei" id="title">
        ...
        <div class="information">
            ...
            <a href="https://lib.kobe-u.ac.jp/libraries/list/rieb/">
                <img src="./kousikisaito.svg" alt="kousikisaito" class="officialSite">
            </a>
            <a href="https://lib.kobe-u.ac.jp/libraries/list/rieb/floormap/">
