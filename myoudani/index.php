...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="./myoudani.css">
    ...
    <title>名谷キャンパス - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    <?php include '../../../common/include/gn.php' ?>
    <div id="wrapper">
    <img src="./myoudani.svg" alt="" id="campusname">
    <a href="../">
    ...
    <div id="mapAndPin">
        ...
        <div class="fukidasi" id="tosyokan_fukidasi">
            ...
            <img src="./tosyokan/3.jpeg" alt="tosyokan" class="fukidasi_image" id="tosyokan_image2">
            <a href="./tosyokan/">
