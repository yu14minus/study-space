...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="./fukae.css">
    ...
    <title>深江キャンパス - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    <?php include '../../../common/include/gn.php' ?>
    <div id="wrapper">
    <img src="./fukae.svg" alt="" id="campusname">
    <a href="../">
    ...
    <div id="mapAndPin">
        ...
        <img src="../common/map/pin1.svg" alt="pin1" class="pin" id="rakomo_pin" onclick="showBalloon_rakomo()">
        <div class="fukidasi" id="rakomo_fukidasi">
            <img src="./rakomo.svg" alt="rakomo" class="fukidasi_haikei">
            <img src="./rakomo/1.jpeg" alt="rakomo" class="fukidasi_image" id="rakomo_image">
            <a href="./rakomo/">
                <img src="../common/map/syousaikochira.svg" alt="syousai" class="fukidasi_syousai" id="rakomo_syousai">
            </a>
        </div>
        ...
        <div class="fukidasi" id="tosyokan_fukidasi">
            ...
            <img src="./tosyokan/1.jpeg" alt="tosyokan" class="fukidasi_image" id="tosyokan_image1">
            <img src="./tosyokan/4.jpeg" alt="tosyokan" class="fukidasi_image" id="tosyokan_image2">
            <a href="./tosyokan/">
                <img src="../common/map/syousaikochira.svg" alt="syousai" class="fukidasi_syousai syousai2" id="tosyokan_syousai">
            </a>
        </div>
