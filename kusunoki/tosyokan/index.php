...
<html lang="ja">
  <head>
    ...
    <title>医学分館 - 神戸大学 図書館・ラーコモ紹介</title>
  </head>
  <body>
    <?php include '../../../../common/include/gn.php' ?>
    <div id="wrapper">
        <a href="../">
            <img src="../../common/syousai/kusunoki.svg" alt="kusunoki" id="campusName">
        </a>
        <img src="./taitoru.svg" alt="igaku" id="title">
        ...
        <div class="information">
            ...
            <a href="https://lib.kobe-u.ac.jp/libraries/list/igaku/">
                <img src="./kousikisaito.svg" alt="kousikisaito" class="officialSite">
            </a>
            <a href="https://lib.kobe-u.ac.jp/libraries/list/igaku/floormap/">
